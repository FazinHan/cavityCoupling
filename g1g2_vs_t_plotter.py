...
def log_fit_function(x, a, b):
    return a * np.log(x) + b

# Fit g1 and g2 data
params_log_g1, _ = curve_fit(log_fit_function, t, g1)
params_log_g2, _ = curve_fit(log_fit_function, t, g2)

# Generate fitted values for plotting
t_fit = np.linspace(t.min(), t.max(), 100)
g1_log_fit = log_fit_function(t_fit, *params_log_g1)
g2_log_fit = log_fit_function(t_fit, *params_log_g2)
