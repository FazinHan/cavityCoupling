...
WORKDIR="/scratch/fizaank.phy21.iitbhu/cavityCoupling/new/jobs/$SLURM_JOB_ID"
...
time mpiexec.hydra -genv I_MPI_DEBUG 9 -n $SLURM_NTASKS -genv OMP_NUM_THREADS 40 python revisions.py
