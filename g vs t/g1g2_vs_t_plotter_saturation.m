...
saturationModel = fittype('a * (1 - exp(-b * x)) + c', 'independent', 'x', 'coefficients', {'a', 'b', 'c'});
...
g1_fit_vals = g1_fit.a * (1 - exp(-g1_fit.b * t_fit)) + g1_fit.c;
g2_fit_vals = g2_fit.a * (1 - exp(-g2_fit.b * t_fit)) + g2_fit.c;
